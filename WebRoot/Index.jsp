	...
	cellspacing="0">
          ...
          <tr>
            <td height="24" align="right" bgcolor="#FFFFFF">
                ...
                <a href="DeptServiet?black=sdsdf" target="main">部门查询</a>
                <a href="TitleServlet?opera=fsd" target="main">职务查询</a>
                <a href="StaffServlet?black=sdfsd" target="main">员工查询</a>
                <a href="Logout.html" target="_top">退出登陆</a> 
             </td>
          </tr>
          <tr>
            <td height="24" align="right" bgcolor="#0099CC"> 当前用户：admin 身份：管理员 
...
bgcolor="#ffffff" scrolling="no" frameborder="0">
            </iframe>
        </td></tr></table>
