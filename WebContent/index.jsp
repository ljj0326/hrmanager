	...
	cellspacing="0">
          ...
          <tr>
            <td height="24" align="right" bgcolor="#FFFFFF">
                ...
                <a href="dept/DeptList.html" target="main">部门查询</a>
                <a href="job/JobList.html" target="main">职务查询</a>
                <a href="staff/StaffList.html" target="main">员工查询</a>
        ...
        <table border="0" width="950" height="350" bgcolor="#ffffff" align="center"><tr><td>
            <iframe name="main" src="dept/DeptList.html" width="100%" height="100%" bgcolor="#ffffff" scrolling="no" frameborder="0">
            </iframe>
        </td></tr></table>
